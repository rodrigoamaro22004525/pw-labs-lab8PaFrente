    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pergunta_1', models.CharField(max_length=200, null=True)),
                ('pergunta_2', models.CharField(max_length=200, null=True)),
                ('pergunta_3', models.CharField(max_length=200, null=True)),
                ('pergunta_4', models.CharField(max_length=200, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Portfolio',
